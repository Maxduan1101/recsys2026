...
Same ranking as the first package. It uses only judge-focused/natural/concise/setwise templates, so its Distinct-2 is lower (`0.52209`) but it is less compact-template-heavy than the clean mixed version.
